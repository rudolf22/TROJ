...
for k = dictionary.id
    ...
    %% CMD: flag(k,1) = check_density_sub('id',id{k},'name',name{k},'trivial_name',trivial_name{k},'formula',formula{k})
    cmd{k} = ['flag(k,1) = check_density_sub(''id'',id{k},''name'',name{k}'];
