function flag = check_molar_mass_element()
...
for k = dictionary.id
    ...
    %% CMD: flag(k,1) = check_molar_mass_sub_element('id',id{k},'name',name{k},'trivial_name',trivial_name{k},'formula',formula{k})
    cmd{k} = ['flag(k,1) = check_molar_mass_sub_element(''id'',id{k},''name'',name{k}'];
